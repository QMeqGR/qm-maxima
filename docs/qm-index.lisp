...
("J1m" . ("qm.info" 33155 85 "Functions and Variables for qm"))
("J1m2p" . ("qm.info" 33525 83 "Functions and Variables for qm"))
("J1p" . ("qm.info" 32877 85 "Functions and Variables for qm"))
("J1p2m" . ("qm.info" 33433 83 "Functions and Variables for qm"))
("J1sqr" . ("qm.info" 32682 88 "Functions and Variables for qm"))
("J1z" . ("qm.info" 31247 117 "Functions and Variables for qm"))
("J1zJ2z" . ("qm.info" 33617 85 "Functions and Variables for qm"))
("J2m" . ("qm.info" 33249 86 "Functions and Variables for qm"))
("J2p" . ("qm.info" 32971 86 "Functions and Variables for qm"))
("J2sqr" . ("qm.info" 32779 89 "Functions and Variables for qm"))
("J2z" . ("qm.info" 31373 733 "Functions and Variables for qm"))
...
("Jtm" . ("qm.info" 33344 80 "Functions and Variables for qm"))
("Jtp" . ("qm.info" 33066 80 "Functions and Variables for qm"))
("Jtsqr" . ("qm.info" 33711 1720 "Functions and Variables for qm"))
("Jtz" . ("qm.info" 32115 558 "Functions and Variables for qm"))
("Jz" . ("qm.info" 25697 606 "Functions and Variables for qm"))
("RX" . ("qm.info" 38575 150 "Functions and Variables for qm"))
("RY" . ("qm.info" 38742 150 "Functions and Variables for qm"))
("RZ" . ("qm.info" 38909 907 "Functions and Variables for qm"))
("SM" . ("qm.info" 37740 780 "Functions and Variables for qm"))
("SP" . ("qm.info" 37647 84 "Functions and Variables for qm"))
...
("UU" . ("qm.info" 39889 621 "Functions and Variables for qm"))
("am" . ("qm.info" 43280 874 "Functions and Variables for qm"))
("anticommutator" . ("qm.info" 18296 314 "Functions and Variables for qm"))
("ap" . ("qm.info" 43167 104 "Functions and Variables for qm"))
...
("tpadd" . ("qm.info" 29818 858 "Functions and Variables for qm"))
("tpbra" . ("qm.info" 27806 320 "Functions and Variables for qm"))
("tpbraket" . ("qm.info" 28131 989 "Functions and Variables for qm"))
("tpcfset" . ("qm.info" 29161 103 "Functions and Variables for qm"))
("tpdagger" . ("qm.info" 30685 549 "Functions and Variables for qm"))
("tpket" . ("qm.info" 27481 320 "Functions and Variables for qm"))
("tpscmult" . ("qm.info" 29277 532 "Functions and Variables for qm"))
...
("Functions and Variables for qm" . ("qm.info" 6368 36774))
