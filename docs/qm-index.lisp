...
("J1m" . ("qm.info" 33147 85 "Functions and Variables for qm"))
("J1m2p" . ("qm.info" 33517 83 "Functions and Variables for qm"))
("J1p" . ("qm.info" 32869 85 "Functions and Variables for qm"))
("J1p2m" . ("qm.info" 33425 83 "Functions and Variables for qm"))
("J1sqr" . ("qm.info" 32674 88 "Functions and Variables for qm"))
("J1z" . ("qm.info" 31239 117 "Functions and Variables for qm"))
("J1zJ2z" . ("qm.info" 33609 85 "Functions and Variables for qm"))
("J2m" . ("qm.info" 33241 86 "Functions and Variables for qm"))
("J2p" . ("qm.info" 32963 86 "Functions and Variables for qm"))
("J2sqr" . ("qm.info" 32771 89 "Functions and Variables for qm"))
("J2z" . ("qm.info" 31365 733 "Functions and Variables for qm"))
...
("Jtm" . ("qm.info" 33336 80 "Functions and Variables for qm"))
("Jtp" . ("qm.info" 33058 80 "Functions and Variables for qm"))
("Jtsqr" . ("qm.info" 33703 1720 "Functions and Variables for qm"))
("Jtz" . ("qm.info" 32107 558 "Functions and Variables for qm"))
("Jz" . ("qm.info" 25697 606 "Functions and Variables for qm"))
("RX" . ("qm.info" 38567 150 "Functions and Variables for qm"))
("RY" . ("qm.info" 38734 150 "Functions and Variables for qm"))
("RZ" . ("qm.info" 38901 907 "Functions and Variables for qm"))
("SM" . ("qm.info" 37732 780 "Functions and Variables for qm"))
("SP" . ("qm.info" 37639 84 "Functions and Variables for qm"))
...
("UU" . ("qm.info" 39881 621 "Functions and Variables for qm"))
("am" . ("qm.info" 43272 874 "Functions and Variables for qm"))
("anticommutator" . ("qm.info" 18296 314 "Functions and Variables for qm"))
("ap" . ("qm.info" 43159 104 "Functions and Variables for qm"))
...
("tpadd" . ("qm.info" 29810 858 "Functions and Variables for qm"))
("tpbra" . ("qm.info" 27806 320 "Functions and Variables for qm"))
("tpbraket" . ("qm.info" 28131 981 "Functions and Variables for qm"))
("tpcfset" . ("qm.info" 29153 103 "Functions and Variables for qm"))
("tpdagger" . ("qm.info" 30677 549 "Functions and Variables for qm"))
("tpket" . ("qm.info" 27481 320 "Functions and Variables for qm"))
("tpscmult" . ("qm.info" 29269 532 "Functions and Variables for qm"))
...
("Functions and Variables for qm" . ("qm.info" 6368 36766))
