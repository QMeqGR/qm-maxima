...
first type is given by a _matrix representation_, as in the functions
‘mbra’ and ‘mket’.  ‘mket’s are column vectors and ‘mbra’s are row
vectors, and their components are entered as Maxima _lists_ in the
